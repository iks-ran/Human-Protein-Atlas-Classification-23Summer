...
@MODELS.registry(name="InternImage-T")
class InternImageT(InternImage):
    def __init__(self, **kwargs):
        super(InternImageT, self).__init__(core_op='DCNv3', depths=[4, 4, 18, 4], groups=[4, 8, 16, 32], 
                                           channels=64, offset_scale=1.0, mlp_ratio=4.0, **kwargs)

@MODELS.registry(name="InternImage-S")
class InternImageS(InternImage):
    def __init__(self, **kwargs):
        super(InternImageS, self).__init__(core_op='DCNv3', depths=[4, 4, 21, 4], groups=[5, 10, 20, 40], 
                                           channels=80, layer_scale=1e-5, offset_scale=1.0, mlp_ratio=4.0, 
                                           post_norm=True, **kwargs)

@MODELS.registry(name="InternImage-B")
class InternImageB(InternImage):
    def __init__(self, **kwargs):
        super(InternImageB, self).__init__(core_op='DCNv3', depths=[4, 4, 21, 4], groups=[7, 14, 28, 56], 
                                           channels=112, layer_scale=1e-5, offset_scale=1.0, mlp_ratio=4.0, 
                                           post_norm=True, **kwargs)